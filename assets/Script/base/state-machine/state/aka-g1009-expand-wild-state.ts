...
export class G1009ExpandwildState extends State {
	constructor() {
		super();
		console.log("Expand wild state");
		setTimeout(() => {
			G1009EventManager.GetInstance().notify("ExpandWildStarted", G1009GameController.GetInstance().GetExpandWildIndices());
		}, 100);
	}
