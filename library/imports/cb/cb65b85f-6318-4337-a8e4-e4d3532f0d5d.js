...
exports.Slot45FeatureTriggerState = void 0;
...
var Slot45FeatureTriggerState = /** @class */ (function (_super) {
    __extends(Slot45FeatureTriggerState, _super);
    function Slot45FeatureTriggerState() {
        var _this = _super.call(this) || this;
        console.log("Feature Trigger state");
        setTimeout(function () {
            Slot45_event_manager_1.Slot45EventManager.GetInstance().notify("featuretriggerstarted");
        }, 500);
        return _this;
    }
    Slot45FeatureTriggerState.prototype.EnterFreespins = function () {
        return new Slot45_spin_state_1.Slot45SpinState();
    };
    Slot45FeatureTriggerState.prototype.FeatureComplete = function () {
        return new Slot45_feature_win_state_1.Slot45FeatureWinState();
    };
    Slot45FeatureTriggerState.prototype.EnterBonus = function () {
        return new Slot45_bonus_state_1.default();
    };
    return Slot45FeatureTriggerState;
}(Slot45_state_1.State));
exports.Slot45FeatureTriggerState = Slot45FeatureTriggerState;
